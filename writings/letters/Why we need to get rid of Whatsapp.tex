...
% SUGGESTION: The actual ask (moving off Whatsapp) doesn't arrive until line 76. Consider
% leading with the concrete, lived complaints (see comment near "terrible messenger" below)
% and moving this data-privacy essay to a supporting position, not the spine.
...
% SUGGESTION: This raises the stakes to democracy/Cambridge Analytica to justify what
% turns out to be a chat-app switch. Risks reading as inflated -- the proportion between
% argument and ask feels off. The concrete communication complaints below are the
% stronger, more original case; consider leaning on those instead of/before this.
...
% SUGGESTION: The ask, finally, at line 76 of a ~90-line letter. Consider surfacing this
% much earlier, with the privacy essay following as supporting context rather than preamble.
And today I therefore want to propose we move our Sahaja Yoga communication away from Whatsapp.
% SUGGESTION: The only spiritual/collective framing in the whole letter is this one line.
% The rest of the argument is entirely secular tech-ethics register. Consider grounding
% the case in Sahaja values directly -- attention, distraction, quality of collective
% communication as a spiritual matter -- rather than borrowing outside authority
% (Cambridge Analytica, democracy) to make the case for us specifically.
...
% SUGGESTION: This is the strongest, most original material in the letter -- concrete,
% lived complaints readers will recognize. Consider leading the whole letter with this
...
% SUGGESTION: No mention of migration friction -- older or less tech-comfortable yogis,
% or those with patchy data/devices, may find a new app a real barrier. Worth naming and
% addressing directly (e.g. how the transition will be supported) rather than leaving it
% to surface as pushback later.
If we are serious about changing the world for the better we should consider some alternatives, like \textit{Slack}.
% SUGGESTION: Three separate justifications land in this closing line (ethics, UX,
% efficacy) without one clearly carrying the argument. Consider picking the strongest
% and letting the others support it rather than stacking all three.
...
% ============================================================
% EDITOR'S FEEDBACK SUMMARY
% ============================================================
% Reading this as a member of the collective, the warmth of "Dear Sahaj family"
% is real, but the letter takes ~40 lines of secular tech-ethics essay (data
% collection, marketing, Cambridge Analytica, democracy) before arriving at the
% actual ask -- moving off Whatsapp. That imbalance risks losing readers before
% the point lands, and makes the ask feel smaller than the argument built to
% support it.
%
% The strongest material in the letter is the concrete, lived complaints about
% Whatsapp itself (lost messages, context-free forwards, group sprawl) -- this
% is what will actually move people, more than the privacy/democracy framing
% borrowed from outside sources. Consider leading with it.
%
% The letter is addressed to the collective but argued almost entirely in a
% secular register. The only spiritual/collective framing is one line ("Sahaja
% Yogis should be an example for society"). Grounding the case more directly in
% Sahaja values -- attention, distraction, the quality of collective
% communication as a spiritual matter -- would likely land harder here than
% Cambridge Analytica does.
%
% Practically, there's no acknowledgment of migration friction for older or
% less tech-comfortable yogis, and the closing line stacks three separate
% justifications (ethics, UX, efficacy) instead of committing to one.
%
% Typos (poliitcal, campains, Deomocracy) have already been fixed.
% ============================================================
